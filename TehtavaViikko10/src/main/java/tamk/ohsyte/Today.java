...
import tamk.ohsyte.commands.SQLAddEventToDatabase;
...
@Command(name = "today", subcommands = { ListProviders.class, ListEvents.class, SQLAddEventToDatabase.class }, description = "Shows events from history and annual observations")
public class Today {
    public Today() {
        ...
        List<Event> sqliteEvents = sqliteEventProvider.getEvents();
